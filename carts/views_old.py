...
def add_cart(request, product_id):
    ...
    # try:
        ...
        for item in cart_item:
            ...
            id.append(item.id)
        # Test result on console: print(ex_var_list)

        # Test if current product variation exists in existing variation list
        ...
        if product_variation in ex_var_list:
            ...
            # Check if cart_item not empty and add variation to cart
